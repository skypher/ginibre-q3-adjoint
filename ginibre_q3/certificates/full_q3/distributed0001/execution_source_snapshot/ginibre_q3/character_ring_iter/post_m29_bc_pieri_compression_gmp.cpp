...
int main(int argc, char** argv) {
    ...
    std::cout << "B/C residual Pieri-compression arithmetic GMP verifier\n"
              << "VERIFIES exact inequality: 2*binom(j,rank+1)*s_{j-rank-1} <= s_j\n"
              << "This is the arithmetic implication of the candidate Pieri-compression supplier;\n"
